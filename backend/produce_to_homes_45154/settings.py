"""
Django settings for produce_to_homes_45154 project.
...
ROOT_URLCONF = 'produce_to_homes_45154.urls'
...
WSGI_APPLICATION = 'produce_to_homes_45154.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "produce_to_homes_45154 API",
    "DESCRIPTION": "API documentation for produce_to_homes_45154 App",
    "VERSION": "v1",
}
